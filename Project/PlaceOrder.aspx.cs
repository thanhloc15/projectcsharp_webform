...
namespace Project
{
    public partial class PlaceOrder : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Label6.Text = "Please fill of data. Thanks";
                return;
            }
            DataTable dt;
            dt = (DataTable)Session["buyitems"];
            ...
            {
                String updatepass = "insert into orderdetails(orderid,sno,productid,productname,price,quantity,dateoforder,status) values('" + Label2.Text + "'," + dt.Rows[i]["sno"] + "," + dt.Rows[i]["productid"] + ",'" + dt.Rows[i]["productname"] + "'," + dt.Rows[i]["price"] + "," + dt.Rows[i]["quantity"] + ",'" + Label3.Text + "')";
                String mycon1 = "Data Source=SE130721;Initial Catalog=HaritiShopping;Integrated Security=True";
                SqlConnection s = new SqlConnection(mycon1);
                s.Open();
                SqlCommand cmd1 = new SqlCommand();
            ...
            saveaddress();
            Session.Contents.Remove("buyitems");
